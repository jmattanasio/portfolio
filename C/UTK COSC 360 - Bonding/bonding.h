...
pthread_mutex_t *new_mutex(); /* Allocates, initializes and returns a
new mutex. */
pthread_cond_t *new_cond(); /* Allocates, initializes and returns a
new condition variable. */
void print_state(char c, const char *s); /* Prints the character, the system
state, and the string. */